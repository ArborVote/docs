...
ArborVote is an on-chain voting module for deliberative decision-making that can be integrated into DApps and DAOs.
...
ArborVote fills this gap on the Ethereum blockchain:
